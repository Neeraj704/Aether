...
_SCHEMA: dict[str, SectionMeta] = {
    "ai_providers": SectionMeta(
        ...
        settings={
            "provider": SettingMeta(
                ...
                options=("local", "googleai", "openrouter", "all", "groq"),
            ),
    ...
    "model_config": SectionMeta(
        ...
        settings={
            ...
            "groq_max_tokens": SettingMeta(
                key="groq_max_tokens", type="int", category="hot",
                description="Max tokens for Groq AI provider",
                min_val=256, max_val=131072,
            ),
