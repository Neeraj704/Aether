...
export const COMPONENTS: ComponentDef[] = [
  ...
  c(
    ...
    0,
    [
      { key: 'symbols', label: 'Symbols', type: 'text', value: 'BTCUSDT, ETHUSDT', placeholder: 'Comma separated' },
    ...
    [
      { key: 'exchangeHeaders', label: 'Custom HTTP Headers', type: 'key-value', value: [{ key: 'X-Exchange-Zone', value: 'GLOBAL-BINANCE' }] },
      { key: 'apiKey', label: 'Data Provider API Key', type: 'credential', provider: 'Binance Public Gateway', value: 'binance-public-key', help: 'Authentication key for live tick websocket and historical backfill.' },
      { key: 'datasetRef', label: 'Historical Tick Dataset', type: 'dataset-ref', value: 'ds-binance-15m', help: 'Offline backtest replay dataset.' },
      { key: 'fillHoles', label: 'Interpolate missing ticks', type: 'switch', value: true },
      { key: 'timezone', label: 'Exchange Timezone', type: 'select', options: ['UTC', 'Asia/Kolkata', 'America/New_York', 'Europe/London'], value: 'UTC' },
    ],
    {
