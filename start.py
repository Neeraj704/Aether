...
from src.platforms.ai_providers import GoogleAIClient, OpenRouterClient, LMStudioClient, BlockRunClient, GroqClient
...
def _get_best_device() -> str:
    ...
    Priority: CPU (to save memory in sandbox/containers) or CUDA if forced.
    """
    if os.environ.get("FORCE_DEVICE") == "cuda" and torch.cuda.is_available():
        return "cuda"
    return "cpu"
