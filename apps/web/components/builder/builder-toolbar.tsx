      ...
      <div className="flex min-w-0 items-center gap-2">
        {editing ? (
          ...
          <button
            ...
            className="group flex items-center gap-1.5 max-w-56 truncate rounded-md px-2 py-1 text-[13px] font-medium text-foreground hover:bg-secondary border border-transparent hover:border-border transition-all"
            title="Click to rename strategy"
          >
            <span className="truncate">{bot.name}</span>
            <span className="text-[10px] text-muted-foreground opacity-60 group-hover:opacity-100 transition-opacity">✎</span>
          </button>
        )}
